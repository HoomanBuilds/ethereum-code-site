...
export function Nav() {
  return (
    <nav
      className="absolute left-0 right-0 top-0 z-50 flex h-14 w-full items-center px-5 sm:h-16 sm:px-8 lg:px-14"
    >
      <Link
        href="/"
      ...
      >
        ...
        <span className="hidden sm:inline">ETHEREUM.CODE</span>
      </Link>

      <div className="absolute left-1/2 hidden -translate-x-1/2 items-center justify-center gap-7 md:flex">
        <a
          href="#engines"
      ...
      <div className="ml-auto">
        <a
          ...
          className="inline-flex h-8 items-center gap-2.5 rounded-lg border border-white/[0.08] bg-white/[0.03] px-2.5 font-mono text-[11px] text-white/60 transition hover:border-white/20 hover:bg-white/[0.06] hover:text-white sm:px-3.5"
        >
